% Trayectorias de Caso de uso: Girar dirección izquierda.
...
\begin{UseCase}{CM-CU1.5}{Girar dirección izquierda}{
		Permite al \refElem{Drone} realizar un movimiento giratorio en 
		dirección izquierda (antihorario) respecto a si eje actual, en 
	...
	\UCitem{Propósito}{Realizar el control del movimiento giratorio del 
			\refElem{Drone} en dirección izquierda, con el objetivo
	...
	\UCitem{Postcondiciones}{Realizar el movimiento del \refElem{Drone} en 
		movimiento giratorio dirección izquierda o en sentido 
		antihorario.
	}
	% V.0.1.
	...
	\UCitem{Disparadores}{%
		\begin{Titemize}
			\Titem Requiere de movimiento giratorio antihorario para
