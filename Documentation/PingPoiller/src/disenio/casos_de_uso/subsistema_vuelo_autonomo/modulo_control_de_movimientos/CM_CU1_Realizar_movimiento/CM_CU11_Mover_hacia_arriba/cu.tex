% Trayectorias de Caso de uso: Mover hacia arriba.
...
\begin{UseCase}{CM-CU1.1}{Mover hacia arriba}{
		Permite al \refElem{Drone} moverse en dirección hacia arriba, en 
caso de detectar un obstáculo o comenzar con el despegue.
	}
