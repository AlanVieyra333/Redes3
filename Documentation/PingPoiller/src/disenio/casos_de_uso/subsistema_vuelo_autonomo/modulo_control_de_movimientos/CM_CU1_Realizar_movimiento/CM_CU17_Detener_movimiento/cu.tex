% Trayectorias de Caso de uso: Detener movimiento.
...
\begin{UseCase}{CM-CU1.7}{Detener movimiento}{
		Permite al \refElem{Drone} detener su movimiento actual como 
		precaución de evitar un choque. Después, de cada movimiento, sea 
		mover hacia adelante, hacia atrás, girar derecha, girar 
		izquierda, debe detenerse.
	}
	...
	% V.0.1.
	\UCitem{Propósito}{Realizar el control de detener el movimiento actual 
			del \refElem{Drone}, con el 
			objetivo de cambiar su estado de movimiento y tomar 
			decisiones de vuelo. Puede ser que previamente se haya 
	...
	\UCitem{Postcondiciones}{%
		Detener el movimiento del \refElem{Drone}.
	}
	% V.0.1.
	...
	\UCitem{Disparadores}{%
		\begin{Titemize}
			\Titem Requiere de detenerse para tomar la siguiente 
			decisión de vuelo.
			\Titem Evitar el choque con algún obstáculo.
		\end{Titemize}
	} 
	% V.0.1.
